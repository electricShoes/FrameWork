            ...
            <div class=" row">
                <div class="col-10">
                    <div class="form-group row">
                        <label for="langGb" class="col-1 col-form-label right">언어</label>
                        <div class="col-2">
                         <!--  <input type="text" id="langGb" data-enter="search" name="langGb" class="form-control" placeholder="언어구분" /> -->
                            <code:commCode className="form-control" prefixValue="" prefixLabel="전체" id="langGb" name="langGb" mstCd ="LANG_CD" selectedValue="KO"/>
                        </div>
                        <label for="gubnCd" class="col-1 col-form-label right">다국어 구분</label>
                        <div class="col-2">
                            <code:commCode className="form-control" prefixValue="" prefixLabel="전체" id="gubnCd" name="gubnCd"  mstCd ="LANG_GUBN" selectedValue=""/>
                        </div>
                        
                        <label for="langCd" class="col-1 col-form-label right">다국어 코드</label>
                        <div class="col-2">
                          <input type="text" id="langCd" data-enter="search" name="langCd" class="form-control" placeholder="다국어 코드" />
                        </div>   
                        
                        <label for="langNm" class="col-1 col-form-label right">다국어</label>
                        <div class="col-2">
                          <input type="text" id="langNm" data-enter="search" name="langNm" class="form-control" placeholder="다국어" />
                        </div>                     
...
function newLang(element,data){
	var url = "<c:url value='/${currentMenuId}/add${urlSuffix}'/>";
    Utilities.windowOpen(url,"addLang",700,350);
}
function search()
{
