            ...
            <div class="card-body p-0">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        <label for="userNm" class="col-1 col-form-label right">Division</label>
                        ...
                        <label for="userId" class="col-1 col-form-label right">Sales group</label>
                        <div class="input-group col-2">

                            <input required="required" type="text" data-change="resetCheckId" class="form-control"
                                value='<c:out value="${user.userId }" />' id="userId" name="userId" placeholder="Sales group">

                        </div>

                        <label for="pwd" class="col-1 col-form-label right">Distribute Channel</label>
                        <div class="col-2">
                            <input type="password" autocomplete="false" required="required" maxLength="16"
                                class="js-mytooltip-pw form-control" id="pwd" name="pwd" placeholder="Distribute Channel"
                        ...
                        <label for="pwdCfg" class="col-1 col-form-label right">Sale Office</label>
                        <div class="col-2">
                            <input type="password" autocomplete="false" required="required" maxLength="16" class="form-control"
                                id="pwdCfg" name="pwdCfg" placeholder="Sale Office">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="emlAdr" class="col-1 col-form-label right">Customer Group</label>
                        <div class="col-2">
                            <input type="email" value='<c:out value="${user.emlAdr }"/>' required class="form-control" id="emlAdr"
                                name="emlAdr" placeholder="Customer Group">
                        </div>
                        ...
                        <label for="langGb" class="col-1 col-form-label right">Sales District</label>
                        <div class="col-2">
