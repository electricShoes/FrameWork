              ...
              <form class="form-horizontal" id="frmMain">
                ...
                <div class="card-body">
                 <div class="form-group row">
                  ...
                  <div class="form-group row">
                    <label for="userId" class="col-2 col-form-label right">로그인아이디</label>
                  ...
                  <div class="form-group row">
                    <label for="pwd" class="col-2 col-form-label right">암호</label>
                    <div class="col-10">
                  ...
                  <div class="form-group row">
                    <label for="pwdCfg" class="col-2 col-form-label right">암호확인</label>
                    <div class="col-10">
                  ...
                  <div class="form-group row" >
                    <label for="pwdXprDt" class="col-2 col-form-label right">암호만료일</label>
                    <div class="col-10">
                      <input type="email" value='<c:out value="${user.pwdXprDt }"/>' data-type="date" data-button="Y" required class="form-control" id="pwdXprDt" name="pwdXprDt"  placeholder="암호만료일">
                    </div>
                  </div>
                  <div class="form-group row" >
                    <label for="emlAdr" class="col-2 col-form-label right">이메일</label>
                    <div class="col-10">
                      <input type="email" value='<c:out value="${user.emlAdr }"/>' required class="form-control" id="emlAdr" name="emlAdr"  placeholder="이메일">
                    </div>
                  </div>
                  <%-- <div class="form-group row" >
                    <label for="mobileNo" class="col-2 col-form-label right">전화</label>
                    <div class="col-10">
