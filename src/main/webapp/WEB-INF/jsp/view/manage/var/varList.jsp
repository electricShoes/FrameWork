    ...
    <div class="col-12">
        <div class="card card-primary card-outline">
            ...
            <div class="card-body p-0">
                <div id="divGrid"   data-grid-id="grdList" data-pagenation="Y" data-type="grid" data-grid-callback="onGridLoad" data-tpl-url="<c:url value='/gridTemplate/var/varList.xml'/>">
                </div>
            </div>
...
function saveUser(){
    ...
    if(saveJson.length){
        ...
        Utilities.getAjax(url,saveJson,true,function(data,jqXHR){
            if(Utilities.processResult(data,jqXHR,"변수 저장에 실패했습니다."))
            {
                alert("변수 저장에  성공했습니다.");
